...
export default function CameraDetailPage({ params }: ProductDetailPageProps) {
  ...
  // Mock promotions for camera
  const cameraPromotions = [
    "Thẻ nhớ giảm giá 20% khi mua kèm Camera",
    ...
    "Tặng kèm túi đựng camera cao cấp"
  ];

  const breadcrumbs = [
    { label: "Trang chủ", href: "/" },
    { label: "Camera", href: "/camera" },
    { label: product.name, href: `/camera/${slug}` }
  ];
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="grid gap-8 grid-cols-1 lg:grid-cols-12">
            ...
            <div className="space-y-6 lg:col-span-7">
              ...
              {/* Promotions & Gifts */}
              <ProductPromotions promotions={cameraPromotions} />
